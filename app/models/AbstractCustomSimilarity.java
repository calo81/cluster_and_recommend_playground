 ...
 */
abstract class AbstractCustomSimilarity extends AbstractItemSimilarity implements UserSimilarity {
    ...
    /**
     * <p>
     * Creates a possibly weighted {@link AbstractCustomSimilarity}.
     * </p>
     */
    AbstractCustomSimilarity(final DataModel dataModel, Weighting weighting, boolean centerData) throws TasteException {
        super(dataModel);
     ...
     * @param sumXY      sum of product of user/item preference values, over all items/users preferred by both
     *                   users/items
        ...
        while (true) {
            ...
            if (hasInferrer || compare == 0) {
                ...
                if (xIndex == yIndex) {
                    ...
                    // Adding magical number to specify that it will be either 1 or 0
                    if (x % 1000 == 153 || y % 1000 == 153) {
